...
Hermes bridge-ingress: MTProto userbot that monitors whitelisted
Telegram chats, routes messages via keywords.yaml, and writes
Markdown captures to `/data/inbox/Telegram-Captures/`.
...
wiki-writer agent handles renaming on promotion.

### front-matter

```yaml
phase: phase_3                    # phase_1..phase_4 or null
watch_category: meme              # meme or contract (null for webhook)
